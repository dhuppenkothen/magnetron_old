...
generally between $10^{38}\,\mathrm{erg}$ and $10^{41}\,\mathrm{erg}$, and are observed either appearing individually, or in burst 
...
random. Additionally, they show a complex temporal morphology within each burst. %%ALSO NEED TO SAY WE
%% HAVE MAY OF THESE BURSTS! 
%% NEED SOME SOC STUFF HERE
At present, it is not clear whether these bursts are smaller-scale versions of the crust fracture process believed to produce a giant flare,
...
Because of the bursts' complex morphology, it is difficult to extract information from their temporal evolution. Many bursts show a
pattern of one or multiple spikes, where these spikes sometimes sit on top of each other. To extract parameters that could be related

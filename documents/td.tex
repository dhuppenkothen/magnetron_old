...
Here we will nevertheless proceed with the definitions from \citet{vandrrhorst2012} to identify individual bursts, with intra-burst variability to be further characterised using the 
...
Dead time is harder to quantify and account for than saturation. It is possible to heuristically correct count rates based on simulations of the instrument \citep{meegan2009,briggs2010,chaplin2013},
but this will not remove the deviation of the statistical distribution of the counts in a bin from a Poisson distribution.
...
energy and information to other weak points must proceed through this shell. The waiting time distribution expected from the simple toy model is 
